...
short opl3_test(short channel, int argc, const char * argv[]) {
    ...
    // Even a tidy delay is enough to avoid the issue.
    long delay = argc > 0 ? atol(argv[1]) : 5;
