...
#ifndef __GABE_C256_H
#define __GABE_C256_H

#define GABE_CTRL_REG		((volatile unsigned char *)0xafe880)
#define POWER_ON_LED		0x01
#define SDCARD_LED			0x02
#define BUZZER_CONTROL		0x10
#define MANUAL_RESET		0x80		    // Make sure the word "DEAD" is written in GABE_RESET_ID

#define GABE_RESET_ID		((volatile unsigned short *)0xafe882)
...
#define GABE_DIP_USER_REG   ((volatile unsigned char *)0xafe80d)
#define GABE_DIP_USER_MASK  0x0003      /* Mask for the user switches: */

#define GABE_DIP_REG        ((volatile unsigned char *)0xafe80e)
